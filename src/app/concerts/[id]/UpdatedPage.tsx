...
export default function ConcertDetails({ params }: Params) {
  const { id } = params;
  ...
  const total = parsePrice(concert.price) * quantity;
  const checkoutHref = `/checkout?eventId=${id}&quantity=${quantity}`;
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="bg-glass-bg-light backdrop-blur-xl rounded-3xl p-10 lg:p-12 border border-glass-border shadow-2xl">
            <div className="text-center lg:text-left space-y-6">
              ...
              <QuantitySelector 
                maxTickets={concert.maxTickets} 
                onQuantityChange={setQuantity} 
              />
              <div className="text-4xl font-black text-accent-gold text-center">
