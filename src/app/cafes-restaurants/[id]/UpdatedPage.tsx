...
export default function CafeDetails({ params }: Params) {
  const { id } = params;
  const cafe = cafesRestaurants.find((c) => c.id === id);
  ...
  const total = parsePrice(cafe.price) * quantity;
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div className="bg-glass-bg-light backdrop-blur-xl rounded-3xl p-10 lg:p-12 border border-glass-border shadow-2xl">
            <div className="text-center lg:text-left space-y-6">
              ...
              <QuantitySelector 
                maxTickets={cafe.maxTickets} 
                onQuantityChange={setQuantity} 
              />
              <div className="text-4xl font-bold text-accent-gold text-center">
